  ...
  Map udata = {};
    ...
    Future<void> _getitsids() async{
      ...
      SharedPreferences prefs = await SharedPreferences.getInstance();
        ...
        itsids += prefs.containsKey('itsid2') ? prefs.getString('itsid2')!+',':'';
        itsids += prefs.containsKey('itsid3') ? prefs.getString('itsid3')!+',':'';
        itsids += prefs.containsKey('itsid4') ? prefs.getString('itsid4')!+',':'';
        itsids += prefs.containsKey('itsid5') ? prefs.getString('itsid5')!+',':'';
